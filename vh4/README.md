...
# NEXT UP
- [ ] Add corresponding handlers to services
- [ ] Add shutdown and init methods for local dev using this https://www.thegeekstuff.com/2016/04/docker-compose-up-stop-rm/
